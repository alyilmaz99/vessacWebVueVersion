  ...
  <header id="header">
    ...
    <div class="header-container">
      ...
      <nav class="header-nav">
        ...
        <ul>
          <li>
            <router-link to="/" title="Anasayfa">.anasayfa()</router-link>
          </li>
          <li>
            <router-link to="/about" title="Hakkımızda">.hakkımızda()</router-link>
          </li>
          <li>
            <a :href="`mailto:${data.email}`" title="Email gönder"
              >.email()</a
            >
          </li>
