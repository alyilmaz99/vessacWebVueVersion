<template>
  <div class="bizScene">
    <TitleSection scene="bizTitle">
      <TitleFunction params="2022,-">kuruluş</TitleFunction>
    </TitleSection>

    <SceneSection id="biz1">
      <TextBlock>
        <p class="-big">
          2022 yılının mart ayında kurulduktan itibaren
          <strong class="-purple">Oyun Geliştirme</strong>
          
          üzerine çalışmaktayız @
          <a
            href="https://www.instagram.com/vessac.software/"
            target="_blank"
            title="instagram"
          >
          Vessac</a
        ...
        <p>
          Oyun yapmanın yanı sıra AR uygulamaları ve website application gibi alanlarda da çalışmalarımız mevcuttur.
        </p>
      </TextBlock>
      <template #container>
    ...
    <SceneSection id="biz2">
      <TextBlock>
        <p>
          Kurulduğumuzdan itibaren bir çok projenin altına imza attık;
          <span class="-big -purple">
            AR, APP, GAME, WEB,
          </span>
          gibi alanlarda çalıştık.
        </p>
      </TextBlock>
    </SceneSection>
    <SceneSection id="biz3">
      <TextBlock>
        <p>
          vessac şuanda
          <span class="-big">
            <span class="-purple">Binlerce kişiye</span>, ulaşan & topluluk
            kontaktları ile
            <span class="-purple">hızla gelişmeye müsait</span> bir yapıya sahiptir.
          </span>
        </p>
      </TextBlock>
    </SceneSection>
